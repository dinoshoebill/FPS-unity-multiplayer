...
public class scr_PlayerController : NetworkBehaviour {
    ...
    private void InitializeInputActions() {
        ...
        input.Player.View.performed += e => inputView = e.ReadValue<Vector2>();
        ...
        input.Player.Crouch.performed += e => SetPlayerStance(PlayerStance.Crouch);
        input.Player.Prone.performed += e => SetPlayerStance(PlayerStance.Prone);
